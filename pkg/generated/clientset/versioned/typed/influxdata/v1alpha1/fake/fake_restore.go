...
type FakeRestores struct {
	Fake *FakeInfluxdataV1alpha1
	ns   string
}

var restoresResource = schema.GroupVersionResource{Group: "influxdata.com", Version: "v1alpha1", Resource: "influxdbrestore"}

var restoresKind = schema.GroupVersionKind{Group: "influxdata.com", Version: "v1alpha1", Kind: "Restore"}
