...
import (
	...
	scheme "github.com/dev9/prod/influxdata-operator/pkg/generated/clientset/versioned/scheme"
...
func newRestores(c *InfluxdataV1alpha1Client, namespace string) *restores {
	return &restores{
		client: c.RESTClient(),
		ns:     namespace,
	}
