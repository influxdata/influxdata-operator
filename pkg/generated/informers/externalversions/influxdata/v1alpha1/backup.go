	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InfluxdataV1alpha1().Backups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InfluxdataV1alpha1().Backups(namespace).Watch(options)
			},
		},
		&influxdatav1alpha1.Backup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&influxdatav1alpha1.Backup{}, f.defaultInformer)
}
